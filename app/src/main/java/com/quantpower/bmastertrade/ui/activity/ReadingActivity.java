...
public class ReadingActivity extends Activity {
    ...
    private void bindRecycleView() {
        this.getData();
        this.myOrderReycAdapter = new RecyclerAdapter<NewsModel>(ReadingActivity.this, myOrderReycList,
                R.layout.item_news) {
            @Override
            public void convert(RecyclerViewHolder helper, NewsModel item, int position) {
                ...
                helper.setText(R.id.news_time, item.getNews_time());
        ...
        this.recyclerView.setLayoutManager(new GridLayoutManager(ReadingActivity.this, 1,
        ...
        this.myOrderReycAdapter.setOnItemClickListener((parent, position) -> {
            ...
            UIHelper.startActivity(ReadingActivity.this, NewsDetailActivity.class, bundle);
        });
    ...
    private void getData() {
        ...
        params.addBodyParameter("read", String.valueOf(10));
